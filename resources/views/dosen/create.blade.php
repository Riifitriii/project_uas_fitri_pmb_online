            ...
            <div class="bg-white p-6 rounded shadow">
                ...
                <div class="mb-6 max-w-3xl">
                    ...
                    <input type="text" id="searchInput" class="mt-1 block w-full border border-gray-300 rounded p-2"
                           placeholder="Cari berdasarkan NIM, Nama, Prodi, atau Dosen...">
                </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Dosen</th>
                                </tr>
                            </thead>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Dosen Pembimbing</th>
                            ...
                            results.forEach(mhs => {
                                tbody.append(`
                                    <tr>
                                        ...
                                        <td class="px-4 py-2">${mhs.dosen || '–'}</td>
                                    </tr>
                                `);
                            });
                        } else {
                            tbody.append(`<tr><td colspan="4" class="px-4 py-2 text-center text-gray-500">Tidak ditemukan</td></tr>`);
                        }
